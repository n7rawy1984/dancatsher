...
const ar: CopyShape<typeof en> = {
  ...
  brand: 'DANCATSHER',
  brandSub: 'دان كاتشر للمقاولات ذ.م.م.',
  ...
  products: {
    ...
    imageAlt: 'أنابيب من الفولاذ المقاوم للصدأ من كتالوج دان كاتشر',
    categories: 'فئات المنتجات',
    note: 'يخضع التوريد لمتطلباتك وتوافر المواد، وتُحدَّد المواصفات عند دراسة كل استفسار.',
  },
  about: {
    eyebrow: '٠٣ / نهج دان كاتشر',
    title: 'رؤية متكاملة.\nمن المخطّط إلى الموقع.',
    description:
      'تأسّست دان كاتشر في أبوظبي عام 2018، لتجمع الهندسة وخدمات المباني وتوريد المواد تحت سقف واحد.',
  ...
  footer: {
    ...
    divisions: 'قطاعاتنا',
    contact: 'تواصل معنا',
    rights: 'دان كاتشر للمقاولات ذ.م.م. جميع الحقوق محفوظة.',
    poBox: 'ص.ب.',
